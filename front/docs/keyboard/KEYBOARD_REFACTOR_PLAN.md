...
- [x] `front/context/KeyboardContext.jsx` (검토 완료: 이벤트/애니메이션 구조 유지)
- [x] `front/view/src/chat/hooks/useChatScroll.js` (검토 완료: 키보드 스크롤 보정 로직 유지)
- [x] `front/view/src/boardDetail.jsx` (검토 완료: 댓글 포커스/스크롤 보정 이미 적용됨)
- [x] `front/view/src/schoolMailDetail.jsx` (검토 완료: 댓글 포커스/스크롤 보정 이미 적용됨)
- [x] `front/view/src/chat/screens/ChatScreen.jsx` (검토 완료: KAV/offset 구조 유지)
- [x] `front/view/src/chat/components/MessageInput.jsx` (검토 완료: 키보드 높이 기반 padding 구조 유지)
- [x] `front/components/CommentInput.jsx` (검토 완료: 상위 제어 구조 유지)

## B. 폼/입력 화면 (중요)

- [x] `front/view/src/Login.jsx` (1차 적용 완료)
- [x] `front/view/src/searchscreen.jsx` (1차 적용 완료)
- [x] `front/view/src/SearchResult.jsx` (1차 적용 완료)
- [x] `front/view/src/sendmailscreen.jsx` (1차 적용 완료)
- [x] `front/view/src/sendSchoolMailScreen.jsx` (1차 적용 완료)
- [x] `front/view/src/boardWrite.jsx` (1차 적용 완료)
- [x] `front/view/src/PWfind.jsx` (1차 적용 완료)
- [x] `front/view/src/IDfind.jsx` (1차 적용 완료)
- [x] `front/view/src/changepassword.jsx` (1차 적용 완료)
- [x] `front/view/src/changeschool.jsx` (1차 적용 완료)
- [x] `front/view/src/signup/SignStep1.jsx` (1차 적용 완료)
- [x] `front/view/src/signup/SignStep1-2.jsx` (1차 적용 완료)
- [x] `front/view/src/signup/SignStep2.jsx` (1차 적용 완료)
- [x] `front/view/src/signup/SignStep4.jsx` (1차 적용 완료)
- [x] `front/view/src/signup/SignStepNumber.jsx` (1차 적용 완료)
- [x] `front/view/frame/SearchSubHeader.jsx` (누락 보정: 입력 컴포넌트 분석 반영)

## C. 보강 필요 후보 (키보드 보정 약한 화면)

- [x] `front/components/timerFriendModals.jsx` (실제 수정 완료: 모달 KAV + dismiss 적용)
- [x] `front/view/src/mailreply.jsx` (1차 적용 완료)
- [x] `front/view/src/edittimetable.jsx` (1차 적용 완료)
- [x] `front/view/src/friendsscreen.jsx` (1차 적용 완료)
- [x] `front/view/src/notificationsettings.jsx` (1차 적용 완료)
- [x] `front/view/src/timerModals.jsx` (1차 적용 완료)
