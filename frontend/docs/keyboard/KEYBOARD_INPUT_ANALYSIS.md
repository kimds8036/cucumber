...
- `frontend/view/src/signup/SignStep1.jsx`
  - PASS 인증 번호 입력 폼.
- `frontend/view/src/signup/SignStep1-2.jsx`
  - 보호자 인증 폼.
- `frontend/view/src/signup/SignStep2.jsx`
  - 계정 정보 입력 폼.
- `frontend/view/src/signup/SignStep4.jsx`
  - 이름/학교/학년/반 입력 폼.
- `frontend/view/src/signup/SignStepNumber.jsx`
  - 열람 주소/번호 입력 폼.
...
- `frontend/components/timerFriendModals.jsx`
...
- `frontend/view/src/notificationsettings.jsx`
  - 아이디/비밀번호 입력 `TextInput` 있으나 키보드 이벤트 보정 없음.
- `frontend/view/src/timerModals.jsx`
  - 모달 내 과목/할일 입력 `TextInput` 사용, 키보드 전용 처리 없음.
- `frontend/view/src/mypage.jsx`
...
- `KeyboardProvider` 내부 `onShow`, `onHide` (`frontend/context/KeyboardContext.jsx`)
- 채팅 훅의 키보드 show/hide 리스너 콜백 (`frontend/view/src/chat/hooks/useChatScroll.js`)
- `focusReplyInput`, `scrollToComment`, keyboard show 콜백 (`frontend/view/src/boardDetail.jsx`)
- `focusReplyInput`, `scrollToComment`, keyboard show 콜백 (`frontend/view/src/schoolMailDetail.jsx`)
- `runSearch` (`frontend/view/src/searchscreen.jsx`, `onSubmitEditing` 연동)
- `handleAddHashtag` (`frontend/view/src/boardWrite.jsx`, `onSubmitEditing` 연동)
